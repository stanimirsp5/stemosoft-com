...
docsRouter.get('/endorseMeScreen', (req,res) => res.render('./privacyPolicies/endorseMeScreen'));
docsRouter.get('/stopaninScreen', (req,res) => res.render('./privacyPolicies/stopaninScreen'));
