...
gulp.task(
  ...
  gulp.parallel(
    ...
    function watcher(done) {
      ...
      gulp.watch(
        ['src/theme/sass/**/*.scss', 'src/theme/sass/*.scss', 'src/docs/sass/**/*.scss', 'src/docs/sass/*.scss'],
        gulp.parallel('style_dev_docs')
      );
      // JS Watcher
...
gulp.task(
  'prod',
  gulp.series('prod_assets', gulp.parallel('prod_style', 'prod_scripts', 'prod_views'))
);
// gulp.task(
//   'build',
...
gulp.task(
  'build_docs',
  gulp.series('docs_clean', 'docs_assets', 'build', gulp.parallel('docs_style', 'docs_scripts', 'docs_views'), 'zip', 'zip_docs', 'theme_clean')
);
